...
public class MainActivity extends AppCompatActivity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        findViewById(R.id.btn_test).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(MainActivity.this,TestActivity.class);   //명시적 인텐트
                ...
                startActivityForResult(intent,REQ_TESTCODE); ///☆☆☆☆☆☆☆☆☆☆☆☆☆☆☆☆☆☆결과를 얻어올때 쓰는 인텐트
    ...
    public void onClick(View v) {
        if(v.getId() == R.id.btn_call){
            ...
            //WebView <- 안드로이드에서 인터넷으로 연결해줄수 있는 기능을 가진 객체. OS에서 함
            Intent intent = new Intent(Intent.ACTION_VIEW,Uri.parse("http://www.naver.com"));   //암시적 인텐트
            startActivity(intent);
